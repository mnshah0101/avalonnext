    ...
    <>
      <div className="cases-dashboard-title-container  flex flex-row justify-between">
        ...
        <div className="button">
          <button className="bg-black text-white text-sm font-medium py-2 px-4 rounded-lg">
            Upload File
          </button>{" "}
        </div>
      </div>
      <div className="search-bar w-100 mt-10">
        <div className="pt-2 relative mx-auto text-gray-600">
          ...
          />
          <button type="submit" className=" ml-4 right-0 top-0 mt-5 mr-4">
            <svg
          ...
          <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
            <div>
              <p className="text-sm text-gray-700">
                Showing <span className="font-medium mr-1">1</span>
                to <span className="font-medium mr-1">10</span>
                of <span className="font-medium mr-1">97</span>results
              </p>
            </div>
            <div>
              <nav
